...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 RPI"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 RPI"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 RPI"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 RPI"));
        ...
        labelBalance->setText(QStringLiteral("123.456 RPI"));

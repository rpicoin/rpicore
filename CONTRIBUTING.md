Contributing to RPICOIN Core
============================

The RPICOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rpicoin/rpicore/blob/master/doc/translation_process.md)
...
Where a patchset proposes to change the RPICOIN consensus, it must have been
...
The project leader is the release manager for each RPICOIN Core release.

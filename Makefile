...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Apr 29 18:47:23 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/rpicoin/src/leveldb/libleveldb.a /root/rpicoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/root/rpicoin/src/leveldb/libleveldb.a: FORCE
	cd /root/rpicoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/rpicoin/build/build.h: FORCE
	cd /root/rpicoin; /bin/sh share/genbuild.sh /root/rpicoin/build/build.h

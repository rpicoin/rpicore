...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat May 5 21:36:52 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/Desktop/rpicore/src/leveldb/libleveldb.a /root/Desktop/rpicore/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/Desktop/rpicore/src/leveldb/libleveldb.a; cd /root/Desktop/rpicore/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/Desktop/rpicore/src/leveldb/libleveldb.a: FORCE
	cd /root/Desktop/rpicore/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/Desktop/rpicore/build/build.h: FORCE
	cd /root/Desktop/rpicore; /bin/sh share/genbuild.sh /root/Desktop/rpicore/build/build.h

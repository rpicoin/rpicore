...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed May 2 17:14:14 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/WSP/core/src/leveldb/libleveldb.a /root/WSP/core/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/WSP/core/src/leveldb/libleveldb.a; cd /root/WSP/core/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/WSP/core/src/leveldb/libleveldb.a: FORCE
	cd /root/WSP/core/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/WSP/core/build/build.h: FORCE
	cd /root/WSP/core; /bin/sh share/genbuild.sh /root/WSP/core/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/rpicoin-32.png \
		src/qt/res/icons/rpicoin-80.png \

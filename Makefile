#############################################################################
# Makefile for building: rpicoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat May 5 15:14:00 2018
# Project:  rpicoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile rpicoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/WSP/rpicore/src/leveldb/libleveldb.a /root/WSP/rpicore/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: rpicoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile rpicoin-qt.pro
...
/root/WSP/rpicore/src/leveldb/libleveldb.a: FORCE
	cd /root/WSP/rpicore/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/WSP/rpicore/build/build.h: FORCE
	cd /root/WSP/rpicore; /bin/sh share/genbuild.sh /root/WSP/rpicore/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/rpicoin-16.png \
		src/qt/res/icons/rpicoin-256.png \

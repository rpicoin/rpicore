...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount RXkJqboCmE2mEK4on75umHuejnw3DMpZR1 nullaccount"), std::runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount RFkn6m8Hfai4yyC3k98XZbeFwnFwEgZXj nullaccount"), std::runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage RXkJqboCmE2mEK4on75umHuejnw3DMpZR1 mymessage"), std::runtime_error);
    ...
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage RFkn6m8Hfai4yyC3k98XZbeFwnFwEgZXj " + retValue.get_str() + " mymessage"), std::runtime_error);
    /* wrong address */

...
extern UniValue setzrpiseed(const UniValue& params, bool fHelp);
extern UniValue getzrpiseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrpi(const UniValue& params, bool fHelp);
extern UniValue dzrpistate(const UniValue& params, bool fHelp);

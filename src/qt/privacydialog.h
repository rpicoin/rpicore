...
public:
    ...
    void setZRpiControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzRPI_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzRPI_clicked();
    void on_pushButtonZRpiControl_clicked();

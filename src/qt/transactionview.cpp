...
TransactionView::TransactionView(QWidget* parent) : QWidget(parent), model(nullptr), transactionProxyModel(nullptr),
 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZRPI));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Received RPI from zRPI"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zRPI"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zRpi));

 ...
 */
    ...
    typeWidget->addItem(tr("Received WSP from zRPI"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zRPI"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zWsp));

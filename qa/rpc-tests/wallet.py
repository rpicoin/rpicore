...
#   c) node1 mines 32 blocks, so now node 0 has 60001rpi, node 1 has 4250rpi, node2 has none.
#   d) node0 sends 601 rpi to node2, in two transactions (301 rpi, then 300 rpi).

...
#   c) node1 mines 32 blocks, so now node 0 has 60001wsp, node 1 has 4250wsp, node2 has none.
#   d) node0 sends 601 wsp to node2, in two transactions (301 wsp, then 300 wsp).

RPICOIN Core version *3.3.0* is now available from:  <https://github.com/rpicoin/rpicore/releases>
...
Moving forward from this undesired situation, we are enabling a secure and chain storage friendly solution for the zerocoin public spend (aka zRPI to PIV conversion).
...
Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://github.com/rpicoin/rpicore/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.

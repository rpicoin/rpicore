...
In order to support loading of multiple wallets in RPICoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is RPICoin.cpp.
...
Changes to RPICoin.cpp
----------------------
RPICoin.cpp is the entry point into RPICoin-qt, and as such, will require some minor modifications to provide hooks for

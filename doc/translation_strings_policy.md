...
This document provides guidelines for internationalization of the WISPR Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wispr_en.ts` remains unchanged.

RPICoin Core version 3.0.6 is now available from:

  <https://github.com/RPICoinProject/core/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/RPICoinProject/core/issues>
...
---------------------
Many wallets were having trouble getting past block 908000. This block recalculates certain aspects of the money supply and zRPI transactions, and is known to take longer to sync. Code has been added to allow block 908000 to be validated without the user needing to enter any special commands into the debug console.
...
zRPI Spending Fix
---------------------
zRPI that were minted between block 891730 and 895400 were experiencing an error initializing the accumulator witness data correctly, causing an inability to spend those mints. This has been fixed.
...
- #408 `beae959` Fix "accumulator does not verify" when spending zRPI. (presstab)
...
### Wallet
- #412 `2fb5f17` Double check tx size when creating zRPI tx's. (presstab)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/RPICoinProject-translations/).

...
Note
---------------------
Always use absolute paths to configure and compile RPICoin and the dependencies,
...
memory available when compiling RPICoin Core. With 512MB of memory or less
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, RPICoin should be built with a non-executable stack

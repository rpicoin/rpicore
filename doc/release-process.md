...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/rpicoin/rpicore/blob/master/doc/translation_process.md#synchronising-translations).
...
- Detached signatures will then be committed to the [rpicoin-detached-sigs](https://github.com/rpicoin/detached.sigs) repository, which can be combined with the unsigned apps to create signed binaries.

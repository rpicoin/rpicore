...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/RPICoinProject/core/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/RPICoinProject/gitian.sigs
    git clone https://github.com/RPICoinProject/detached.sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/RPICoinProject/core.git
...
### Build and sign RPICoin Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit RPICoin=v${VERSION} ../RPICoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit RPICoin=v${VERSION} ../RPICoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit RPICoin=v${VERSION} ../RPICoin/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit RPICoin=v${VERSION} ../RPICoin/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../RPICoin/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/RPICoin-*.tar.gz build/out/src/RPICoin-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`RPICoin-${VERSION}-osx-unsigned.dmg`, `RPICoin-${VERSION}-osx64.tar.gz`)
...
Verify the signatures
    ...
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-aarch64 ../RPICoin/contrib/gitian-descriptors/gitian-aarch64.yml
    popd
...
Codesigner only: Sign the osx binary:
    ...
    transfer RPICoin-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [RPICoin-detached-sigs](https://github.com/RPICoinProject/detached.sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the RPICoin.tech server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/RPICoinProject/core/releases/new) with a link to the archived release notes.

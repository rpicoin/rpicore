...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[1].getbalance(), 125000)
        assert_equal(self.nodes[2].getbalance(), 125000)
        assert_equal(self.nodes[3].getbalance(), 11250000)
